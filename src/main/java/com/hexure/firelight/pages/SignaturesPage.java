...
public class SignaturesPage extends FLUtilities {
    ...
    public static String txtFieldWithValue = "//div[@title=\"%s\"]/../../following-sibling::div//input[@value=\"%s\"]";
    ...
    private String sectionHeading = "//div[@class='ITPanelTitleText' and text() ='%s']";
